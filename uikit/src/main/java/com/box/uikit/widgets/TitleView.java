...
import com.box.uikit.utils.DisplayUtils;
...
public class TitleView extends FrameLayout {
    ...
    public TitleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                DisplayUtils.dp2px(context, TITLE_VIEW_HEIGHT));
        setLayoutParams(params);

        View view = LayoutInflater.from(context).inflate(R.layout.ui_widget_title_view, this, false);
...
//
//        String titleString = a.getString(R.styleable.TitleView_text_title);
